...
try:
    db=_mysql.connect("10.37.129.3","martin","root", "martin")
except OperationalError:
    db=_mysql.connect("10.37.129.3","martin","root")
...
def on_message(client, userdata, msg):
    ...
    if correct:
        ...
        sql_data = f"INSERT INTO sensors_data (sensor_id, datetime, martin) VALUES ({id}, '{dt.strftime('%Y-%m-%d %H:%M:%S')}', {martin})"
        print(sql_data)
